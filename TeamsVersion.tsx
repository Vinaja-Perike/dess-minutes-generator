...
import { fetchTeamsMeetingTranscription } from './services/teamsService';
...
export default function TeamsVersion() {
    const [meetingId, setMeetingId] = useState('4347511720655');
    ...
    const handleFetchTranscription = useCallback(async () => {
        ...
        try {
            ...
            // });   
            const data = await fetchTeamsMeetingTranscription(meetingId);    
            console.log(data);    
            ...
            <main className="container mx-auto px-4 py-8 md:py-12">
                <header className="text-center mb-10">
                    <div className="inline-flex items-center gap-3 bg-white shadow-sm rounded-full p-3 mb-4">
                        ...
                        <div className=" text-white p-2 rounded-full"><img src="assets/teams.png" alt="Company Logo" width="48" height="48" /></div>
